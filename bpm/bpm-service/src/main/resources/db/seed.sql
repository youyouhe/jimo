...
-- Departments (two-level: operations center -> business departments)
...
-- ============================================================
-- Resolution rules (core: BPMN references rule names, no hard-coded values)
-- ============================================================
...
-- Purchase contract form definition
...
-- ============================================================
-- Contract categories (different approval chains by amount range)
-- ============================================================
...
-- ============================================================
-- RBAC Permission System seed data
-- ============================================================
...
-- Clear association tables before re-inserting (avoid UNIQUE constraint conflicts)
DELETE FROM role_permissions;
DELETE FROM user_roles;

-- Role-Permissions: System Admin (all permissions)
...
-- Role-Permissions: Contract Manager (contract:* + form:view + process:view)
INSERT IGNORE INTO role_permissions (id, role_id, permission_id) VALUES
...
-- Role-Permissions: Regular User (list/view/create/edit/submit + form:view)
INSERT IGNORE INTO role_permissions (id, role_id, permission_id) VALUES
('RP30','R03','P01'),('RP31','R03','P02'),('RP32','R03','P03'),('RP33','R03','P04'),
('RP34','R03','P06'),('RP35','R03','P09');

-- Role-Permissions: Form Designer (form:design/view + contract:list/view)
INSERT IGNORE INTO role_permissions (id, role_id, permission_id) VALUES
