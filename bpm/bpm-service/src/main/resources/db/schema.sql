...
-- This file defines business tables only.
-- MySQL 8.x syntax.
...
CREATE TABLE IF NOT EXISTS departments (
    ...
    lead_id     VARCHAR(32)             -- department lead user id
);
...
CREATE TABLE IF NOT EXISTS form_definitions (
    ...
    schema_json TEXT         NOT NULL   -- JSON: { fields:[], nodeAcl:{} }
);

CREATE TABLE IF NOT EXISTS resolution_rules (
    rule_name       VARCHAR(50)  PRIMARY KEY,
    label           VARCHAR(100) NOT NULL,
    strategy        VARCHAR(30)  NOT NULL,   -- SELF_DEPT_LEAD / PARENT_DEPT_LEAD / FIXED_DEPT_LEAD / BY_TITLE
    config_json     TEXT                     -- strategy parameters
);
...
CREATE TABLE IF NOT EXISTS form_data (
    ...
    task_definition_key   VARCHAR(100),          -- last save came from which node
    data_json             TEXT,
...
-- Contract fulfillment details
CREATE TABLE IF NOT EXISTS contract_fulfillments (
    id              VARCHAR(32)  PRIMARY KEY,
    contract_id     VARCHAR(32)  NOT NULL,
    seq             INT          NOT NULL DEFAULT 0,
    type            VARCHAR(20)  NOT NULL,      -- MILESTONE/PAYMENT/DELIVERY/CHANGE/TERMINATION
    title           VARCHAR(200) NOT NULL,
    description     TEXT,
    plan_date       DATE,
    actual_date     DATE,
