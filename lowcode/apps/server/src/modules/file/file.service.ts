...
export class FileService {
  ...
  async upload(file: Express.Multer.File): Promise<SysFile> {
    ...
    // Build the access URL — prefer MINIO_PUBLIC_URL for browser-accessible links
    const bucket = process.env['MINIO_BUCKET'] ?? 'lowcode-dev';
    ...
    const url = `${publicBase}/${bucket}/${objKey}`;
